...
\years{2020-now}Master in Academic and Clinical Education, University of Porto\\
...
\years{2021}\euro106K - ``Adaptation, development, and deployment of a chatbot to improve health literacy and care of first-time parents'' funded by Aga Khan Development Network  \& FCT (PT) -- \textit{Project Coordinator and PI.}\\
\years{2020}\euro190K - ``Mobile Patient-centred System to Improve Drug Trials and Care of Older-adults with Rheumatic Diseases'' funded by H2020 AAL \& FCT (PT) -- \textit{Project Coordinator and PI.}\\
...
\years{2021-now}Media Laboratory (PhD @U. Porto)\\
\years{2019-2021}Learning from Users: User Research Methods for Technology Design (MSc/PhD @AICOS)\\
\years{2019-2021}Design Project Management and Methodology (Post-graduation @U. Porto)\\
...
\years{current}Petra Grego, MSc Multimedia Design @U. Coimbra\\
\years{current}Rui Fernandes, MSc Informatics Engineering @U. Nova de Lisboa\\
...
\years{2022-2024}\emph{ParentCoach} (FCT) -- will adapt and improve a chatbot for first-time parents in Portugal and South Africa. I am project coordinator and PI at AICOS.\\
\years{2021-2023}\emph{COTIDIANA} (AAL) -- is creating a mobile solution to enable holistic and efficient patient monitoring for clinical care, clinical research, and drug trials, drawing on PROMS and passive smartphone sensing. I am project coordinator and PI at AICOS. \href{https://cotidiana.eu/}{https://cotidiana.eu/}\\
...
\years{2021-2023}\emph{HomeSenseALS} (FCT) -- is creating a mobile solution to track the condition state of patients with Amyotrophic Lateral Sclerosis in clinical research field trials. I am leading the user research team at AICOS.\\
...
CHI ('14-'21), CSCW ('15-'22), DIS '18, Group '16, Healthcom '13, Interact '19, MobileHCI '17, NordiCHI ('14, '16), PervasiveHealth ('15-'17).
...
h-index: 14; citations: 718 (source Google Scholar as of 08/2021)
...
\years{2021}F. Nunes, P. Madureira, S. Rêgo, C. Braga, R. Moutinho, T. Oliveira, F. Soares (2021) ``Mobile Tele-Ophthalmology System for Planned and Opportunistic Screening of Diabetic Retinopathy in Primary Care''\emph{IEEE Access}, 9: 83740-83750.\\
...
\years{2020}C. Braga, S. Rego, F. Nunes ``Clinicians' Perspectives on Using Mobile Eye Fundus Cameras to Screen Diabetic Retinopathy in Primary Care'', \emph{Proc. of ICHI 2020}.\\
...
\years{2021}F. Nunes, J. Silva (2021) ``Monitoring patients with rheumatic conditions remotely using data from smartphones​'', \emph{Book of abstracts 3rd Digital Rheumatology Day}.\\
